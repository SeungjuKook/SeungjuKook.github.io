...
let str = new String('Kook');
console.log(str.toUpperCase()); //메소드 호출
console.log(str.length); //프로퍼티 접근

let arr = new Array(1000, "kook");
console.log(arr[0]);

//앞의 객체와 MATH객체는 사용방법이 다름. 클라스 변수, 클라스 메소드
//1. 앞의 경우, 객체를 먼저 생성한 후 프로퍼티 또는 메소드를 사용
//2. Math는 객체 생성 없이 사용할 수 있다. 클라스이름.메소드() 또는 클라스이름.프로퍼티
